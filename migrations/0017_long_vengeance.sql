...
CREATE INDEX "idx_enrichment_stage_processed" ON "incident_enrichment_states" USING btree ("enrichment_stage","last_processed_at");--> statement-breakpoint
CREATE INDEX "idx_project_interviews_project" ON "project_interviews" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "idx_project_interviews_candidate" ON "project_interviews" USING btree ("candidate_slack_id");--> statement-breakpoint
CREATE INDEX "idx_project_interviews_completed_at" ON "project_interviews" USING btree ("completed_at");