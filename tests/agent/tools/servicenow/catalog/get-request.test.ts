...
import { createGetRequestTool } from "@/agent/tools/servicenow/catalog/get-request.tool";
import type { Request } from "@/infrastructure/servicenow/types/domain-models";
